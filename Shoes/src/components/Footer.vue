<template>
  <footer class="bg-gray-900 text-white w-full p-4">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between px-8">
      <!-- Başlık -->
      <h2 class="text-white hover:text-gray-500 transition-all duration-500 ease-in-out font-serif italic text-center sm:text-left">
        Muzaffer Nergiz
      </h2>
      <!-- Metin -->
      ...
      <div class="flex justify-center sm:justify-start gap-5 mt-4 sm:mt-0">
        <!-- Instagram Icon -->
